...
uint64 findnthprime(uint32 n)
{
	...
	uint32 count = 3,i = 2,blocksize = 0, start = segmentfactornumber - 3, \
		wheelpointer = 0, s = 0, pointer = 0,tempprime=0,j = 0,tempnext2=0 ;
	uint64 high, low, tempnext1=0; //primes contain 2,3,5
	...
	s = bound & 1 ? 0 : 1;
	wheelpointer = bound%segmentsize;
